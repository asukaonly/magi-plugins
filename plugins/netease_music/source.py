"""Timeline source for NetEase Cloud Music."""
...
class NeteaseMusicTimelineSource(Source):
    """Timeline source for NetEase Cloud Music play records."""
    ...
    memory_policy = SourceMemoryPolicy()  # defaults match design
    ...
    async def _fetch_lastfm_tags_locked(self, artist: str, track: str) -> list[str]:
        ...
        Results are cached in memory for the lifetime of the source instance
