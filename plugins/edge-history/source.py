"""Timeline source for local Edge history."""
...
class EdgeHistoryTimelineSource(BaseBrowserHistoryTimelineSource):
    """Pull-sync source backed by the local Edge history SQLite database."""
