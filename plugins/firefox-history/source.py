"""Timeline source for local Firefox history."""
...
from browser_history_core.source_base import BaseBrowserHistoryTimelineSource

from .firefox_reader import FirefoxHistoryReader


class FirefoxHistoryTimelineSource(BaseBrowserHistoryTimelineSource):
    """Pull-sync source backed by the local Firefox places.sqlite database."""
