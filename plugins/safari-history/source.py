"""Timeline source for local Safari history."""
...
class SafariHistoryTimelineSource(BaseBrowserHistoryTimelineSource):
    """Pull-sync source backed by the local Safari history SQLite database."""
