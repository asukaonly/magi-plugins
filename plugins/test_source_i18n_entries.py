"""Guard source list display names used by the Magi settings UI."""
...
def test_source_status_entries_have_localized_display_text() -> None:
    for plugin_dir, entry_ids in SOURCE_ENTRY_PLUGINS.items():
